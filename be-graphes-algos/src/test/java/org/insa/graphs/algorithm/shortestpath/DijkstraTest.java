...
public class DijkstraTest {
    ...
    public static void initAll() throws IOException {
        ...
        Graph emptyGraph = new Graph("ID", "", null, null);
        Graph singleNodeGraph = new Graph("ID", "", Arrays.asList(nodes), null);
        Graph twoNodeGraph = new Graph("ID", "", Arrays.asList(nodes), null);
